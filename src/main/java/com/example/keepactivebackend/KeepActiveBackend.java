...
import com.example.keepactivebackend.auth.SignUpRequest;
	...
	public CommandLineRunner commandLineRunner(
		...
		return args -> {
			var admin = SignUpRequest.builder()
					...
					.role(ADMIN)
					.build();
			System.out.println("Admin token: " + service.signup(admin).getAccessToken());
			...
			var manager = SignUpRequest.builder()
					...
					.role(MANAGER)
					.build();
			System.out.println("Manager token: " + service.signup(manager).getAccessToken());
